...
const sendWelcomeMail = async (data) => {
  ...
  const mailOptions = {
    ...
    html: `
    <body style="width: 100%; background-color: white; padding: 0; margin: 0;">
    <div
        style="max-width: 850px; margin: 0 auto; background-color: white; padding: 10px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
        <p style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight: 700;">Dear Sir/ Madam,</p>
        <p style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 0; margin: 0;">
            Greetings from Logo
            In Hours LLC.
        </p>
        <p style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding: 0; margin: 0;">
        ...
        <p
            style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding: 0; margin: 0; font-weight: 600; margin-top: 10px;">
        ...
        <div style="margin-top: 20px;">
            ...
            <h3
                style="color: orangered; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding: 0; margin: 0; font-weight: 600; margin-top: 10px; margin-bottom: 12px;">
                EMAIL SIGNATURE
            </h3>

            <p
                style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding: 0; margin: 0; font-size: medium;">
            ...
            <p style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding: 0; margin-top: 30px;">
            ...
            <div style="border-top: 1px solid gray; width: fit-content; padding-top: 5px; margin-top: 20px;">
                ...
                <p
                    style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding: 0; font-weight: 700; margin: 0; font-size: 18px;">
                    Logo In Hours LLC
                </p>
                ...
                <p
                    style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding: 0; font-weight: 600; margin-top: 10px;">
                ...
                <p
                    style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;  padding: 0; margin: 0; font-size: medium; font-weight: 600;">
                    24/7:
